...
import {Scanner, Confirmed} from './Icons'
...
{this.props.isVerified ? <Confirmed/> : <Scanner/> } 
<br/>
<br/>
    <h1 className=" textRobot">
    <Typed
                    strings={["INITIALIZING...","AUTHENTICATING...","ACCESS GRANTED " ]}
                    typeSpeed={100}
                    backSpeed={50}
                    backDelay={2000}
    ...
    <div className={`scrollDown text-white ${this.props.isVerified ? "animated fadeIn slower" : "d-none"}`}>
